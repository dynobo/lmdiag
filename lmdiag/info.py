...
desc = {
    "resid_fit": {
        ...
        "Description": (
            "It's purpose is to identify non-linear patterns "
    ...
    "q_q": {
        ...
        "Description": (
            "It's purpose is to check, if the residuals are "
    ...
    "scale_loc": {
        ...
        "y-Axis": (
            "Square root of the absolute value of the Standardized " "Residuals."
        ),
        "Description": (
            'It\'s purpose is to check "homoscedasticity" '
            "the assumption of equal variance. "
            "The plot shows, if the residuals are spread "
            "equally across the range of predictors (Fitted "
            "values). The red line should be horizontal and "
    ...
    "resid_lev": {
        ...
        "x-Axis": (
            'Leverage (The "influence" of an observation. A '
            "measure of how far away the dependent variables value "
        ...
        "Description": (
            "It's purpose is to identify observations with "
            "high influence on calculating the regression. "
            "Those observation might but not have to be "
...
def print_desc(plot_name: str) -> None:
    """Print description of plot nicely formatted."""
    for key, val in desc[plot_name].items():
